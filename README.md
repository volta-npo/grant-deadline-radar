...
**Finance & Grants** · **Repo 12/50** · **No backend. No login. Client data stays local.**
...
**Grant Deadline Radar** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Finance pods managing multiple grant applications turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
