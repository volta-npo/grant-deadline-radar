    ...
    "criteria": [
        {
            ...
            "guidance": "Implement and verify deadline calendar with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "guidance": "Implement and verify document request checklist with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            "id": "reviewer-queue",
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "guidance": "Implement and verify reviewer queue with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "guidance": "Implement and verify submission readiness states with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            "id": "evidence-quality",
