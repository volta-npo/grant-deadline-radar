export const v3 = {
    ...
    "capabilities": [
        "Domain-specific workbench: Grant Timeline Radar",
        "Operational table: Grant milestones",
    ...
    "releaseChecklist": [
        ...
        "Submission Readiness reaches production threshold",
        "Deadline Risk is documented with evidence",
        "Document Coverage has no unresolved blocker",
        "ICS calendar verified",
        "Task CSV verified",
        "Submission readiness report verified"
    ],
    "operations": [
